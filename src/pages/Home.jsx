...
const Home = () => {
  ...
  <span className="block text-blue-900">Digital Presence</span>
          ...
          <div className="absolute bottom-20 right-10 w-32 h-32 bg-blue-400/20 rounded-full blur-xl floating-animation" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/2 left-20 w-16 h-16 bg-purple-400/20 rounded-full blur-xl floating-animation" style={{ animationDelay: '4s' }}></div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <img  
                 ...
                 src="https://images.unsplash.com/photo-1531537111426-33a268254c48" />
